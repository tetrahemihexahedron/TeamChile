# NM Harvest Base — Team Chile

**[Desert Dev Lab 2026](https://www.nmtechtalks.com/desert-dev-lab) · NM Tech Talks · April 18-19, 2026**
...
ASP-approved local farms. NM Harvest Base closes that gap.
...
The database schema already exists in Supabase, so you should never run
...
Farmers can call or text (505) NM-GROW and NM Harvest Base
staff will create listings on their behalf.
...
DDL2026 — NM Harvest Base Mock-Ups/
